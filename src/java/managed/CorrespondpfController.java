...
import session.CorrespondpfFacade;
...
public class CorrespondpfController implements Serializable {
    ...
    private Correspondpf current;
    private DataModel items = null;
    @EJB
    private session.CorrespondpfFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Correspondpf) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CorrespondpfCreated"));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CorrespondpfDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class CorrespondpfControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Correspondpf) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Correspondpf.class.getName());
            }
        }
